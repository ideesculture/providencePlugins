...
?>
<h1>Résultat de l'import Gallica</h1>

<style>
.gallica-result { padding: 8px 12px; margin-bottom: 8px; border-radius: 4px; font-size: 14px; }
.gallica-result.ok    { background: #dff0d8; border-left: 4px solid #3c763d; }
.gallica-result.skip  { background: #fcf8e3; border-left: 4px solid #8a6d3b; }
.gallica-result.error { background: #f2dede; border-left: 4px solid #a94442; }
.gallica-result .ark  { font-family: monospace; font-size: 12px; color: #333; margin-right: 8px; }
.gallica-result .msg  { color: #555; font-size: 12px; }
</style>
...
<?php else: ?>
	...
	<?php foreach ($results as $r): ?>
		<div class="gallica-result <?php echo htmlspecialchars($r['status']); ?>">
			<span class="ark"><?php echo htmlspecialchars($r['ark']); ?></span>
