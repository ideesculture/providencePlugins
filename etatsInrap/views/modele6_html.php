...
<div style="margin-bottom:30px;">
    <a class="btn button" href="<?=__CA_URL_ROOT__?>/app/plugins/etatsInrap/views/modele6_docx.php?date=<?= $timeStamp;?>" style="cursor: pointer;border:1px solid #ccc;padding:10px;">Télécharger le fichier DOCX</a>
</div>
<table id="table">
<?php 
