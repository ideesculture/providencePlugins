...
?>
<div class="crumb"><div class="crumbtext navBreadCrumbLabel"><?php print IdC::_t('Current location'); ?></div><img src="<?php print $arrow_loc; ?>" width="16" height="19" border="0" alt=""></div><div class="crumb"><nobr><div class="crumbtext"><a href="<?php print $sections_url; ?>"><?php print IdC::_t('Book editor'); ?></a></div><img src="<?php print $arrow; ?>" width="16" height="19" border="0" alt=""></nobr></div><div class="crumb"><nobr><div class="crumbtext"><?php print IdC::_t('Edit section'); ?></div><img src="<?php print $arrow; ?>" width="16" height="19" border="0" alt=""></nobr></div>
	</div><!-- end navBreadCrumbs-->
</div>


<h1><?php print IdC::_t('Section'); ?></h1>
...
print $vs_control_box = caFormControlBox(
	//left
	caFormSubmitButton($this->request, __CA_NAV_ICON_SAVE__, IdC::_t("Save"), 'editSectiontext').' '.
	caNavButton($this->request, __CA_NAV_ICON_CANCEL__, IdC::_t("Cancel"), '', "*", "*", "BookSections/book/$book_id/section/$section_id", array()).' ',
	//middle
	'',
	//right
	caNavButton($this->request, __CA_NAV_ICON_DELETE__, IdC::_t("Delete"), '', "*", "*", "deleteSection/book/$book_id/section/$section_id", array())
...
<label style="font-weight: normal;" class="pull-right">
  ...
  <?php print IdC::_t('This section appears in the table of contents'); ?>
</label>

<h3 type="button" data-toggle="collapse" data-target="#collapseIntro" aria-expanded="false" aria-controls="collapseExample">
	<i class="fa fa-plus-square-o" aria-hidden="true"></i> <?php print IdC::_t('Introduction/summary'); ?>
</h3>
...
<h3 type="button" data-toggle="collapse" data-target="#collapseStyle" aria-expanded="false" aria-controls="collapseExample">
	<i class="fa fa-plus-square-o" aria-hidden="true"></i> <?php print IdC::_t('Style'); ?>
</h3>
<div class="collapse" id="collapseStyle">
	...
	<p><?php print IdC::_t('No layout is available for the page format of this book.'); ?></p>
	<?php } ?>
	</div>
</div>

<h3><?php print IdC::_t('Content'); ?></h3>
...
<h3 type="button" data-toggle="collapse" data-target="#collapseRepresentation" aria-expanded="false" aria-controls="collapseRepresentation">
	<i class="fa fa-plus-square-o" aria-hidden="true"></i> <?php print IdC::_t('Representation'); ?>
</h3>
...
<h3 type="button" data-toggle="collapse" data-target="#collapseSet" aria-expanded="false" aria-controls="collapseSet">
	<i class="fa fa-plus-square-o" aria-hidden="true"></i> <?php print IdC::_t('Set'); ?>
</h3>
...
print $vs_control_box = caFormControlBox(
	caFormSubmitButton($this->request, __CA_NAV_ICON_SAVE__, IdC::_t("Save"), 'editSectiontext').' '.
	caNavButton($this->request, __CA_NAV_ICON_CANCEL__, IdC::_t("Cancel"), '', "*", "*", "BookSections/book/$book_id/section/$section_id", array()).' '.
	caNavButton($this->request, __CA_NAV_ICON_PDF__, IdC::_t("Preview this section"), '', "bookCreator", "Preview", "Section", array('book' => $book_id, 'section' => $section_id)),
	'',
	caNavButton($this->request, __CA_NAV_ICON_DELETE__, IdC::_t("Delete"), '', "*", "*", "deleteSection/book/$book_id/section/$section_id", array())
