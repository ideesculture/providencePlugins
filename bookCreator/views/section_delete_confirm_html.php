...
<h1><?php print IdC::_t('Delete section'); ?></h1>

<?php if ($error) { ?>
	<div class="alert alert-danger"><?php print htmlspecialchars((string)$error, ENT_QUOTES, 'UTF-8'); ?></div>
<?php } ?>

<p><?php print IdC::_t('Delete “%1”? This cannot be undone.', htmlspecialchars((string)$label, ENT_QUOTES, 'UTF-8')); ?></p>
<?php
...
print caFormControlBox(
	caFormSubmitButton($this->request, __CA_NAV_ICON_DELETE__, IdC::_t("Delete"), 'editSectiontext').' '.
	caNavButton($this->request, __CA_NAV_ICON_CANCEL__, IdC::_t("Cancel"), '', "*", "*", "editSection", array('book' => $book_id, 'section' => $section_id)),
	'',
	''
);?>
</form>
